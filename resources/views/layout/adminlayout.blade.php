    ...
    <div class="wrapper">
        ...
        <div class="sidebar-wrapper" data-simplebar="true">
            <div class="sidebar-header">
                ...
                <div>
                    <h4 class="logo-text">Monitoring</h4>
                </div>
            ...
            <ul class="metismenu" id="menu">
                ...
                <li>
                    <a href="/pipa">
                        <div class="parent-icon"><i class="lni lni-heart-monitor"></i>
                        </div>
                        <div class="menu-title">Pipa</div>
                    </a>
                </li>
                <li>
                    <a href="/olahan">
                        ...
                        <div class="menu-title">Olahan</div>
                    </a>
                </li>
            </ul>
            <!--end navigation-->
                    ...
                    <div class="user-box dropdown">
                        <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret"
                            ...
                            @if (Auth::user()->image == null)
                                <img src="/assets/images/avatars/avataruser.png" class="user-img" alt="user avatar">
                            @else
                                <img src="{{ asset('storage/photo/' . Auth::user()->image) }}" class="user-img"
                                    alt="user avatar">
                            @endif
